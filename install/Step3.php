...
<tr>
<td align="left">School Name </td><td></td><td>
<input type="text" class="form-control" name="beedySchoolName" id="beedySchoolName" placeholder="Enter School Name" required></td>
</tr>



<tr>
<td align="left">School Motto</td><td></td><td><input type="text" class="form-control" name="beedySchoolMotto" id="beedySchoolMotto" placeholder="Enter School Motto" required>
</td>
</tr>

<!--<tr>
<td align="left">School Address</td><td> </td><td><input type="text" class="form-control" name="beedySchoolAddress" id="beedySchoolAddress" placeholder="Enter School Address" required>
</td>
</tr>-->
<tr>
<td align="left">Email</td><td></td><td> <input type="email" class="form-control" name="beedySchoolEmail" id="beedySchoolEmail" placeholder="Enter School Email" required>
</td>
</tr>
<tr>
<td align="left">Phone Number</td><td> </td><td><input type="text" class="form-control" name="beedySchoolPhoneNum" id="beedySchoolPhoneNum" placeholder="Enter School Phone Number" required>
</td>
</tr>
<!--<tr>
<td align="left">School Website</td><td>  </td><td><input type="text" class="form-control" name="beedySchoolWebsite" id="beedySchoolWebsite" placeholder="Enter School Website" >
</td>
</tr>-->
</tr>
<tr>
<td align="left">School Logo</td><td> </td><td><input type="file" class="form-control" name="photo" id="photo" placeholder="Enter your Photo"></td>
</tr>
<tr>
