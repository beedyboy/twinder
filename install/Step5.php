...
$display_text='';
  ...
  if($_SESSION['mod']!='upgrade'){
		$display_text="A  school has been created in the name of: ".$_SESSION['beedySchoolName'].".
You need to follow the instructions in the administrator manual for setting up the school properly.";
