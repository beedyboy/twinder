	...
	<tr>
	  <td align="left" valign="top"><table width="100%" border="0" cellpadding="4" cellspacing="0" id="table1">
		  <tr>
			...
			<td width="140"><input type="text" class="form-control" name="firstName" id="firstName"  tabindex="1" placeholder="Enter First Name" required>
  </td>
			<td width="100">Username:</td>
			<td>
			<input type="text" class="form-control" name="username" id="username" tabindex="5" placeholder="Enter Username" onblur="check_username_install(this.value);" required /></td>
		  ...
		  <tr>
			<td>Last Name:</td>
			<td><input type="text" class="form-control" name="lastName" id="lastName" tabindex="2" placeholder="Enter Last Name" required>
  </td>
			<td>Password:</td>
			<td>	<input type="password" class="form-control" name="password" id="password" tabindex="6" placeholder="Enter Password" required autocomplete="off" onkeyup="passwordStrength(this.value);" /></td>
		  </tr>
		  <tr>
			<td>Photo:</td>
			<td><input type="file" class="form-control" name="photo" id="photo" tabindex="3" placeholder="Enter your Photo"></td>
			<td>Confirm Password:</td>
			<td><input type="password" class="form-control" id="capassword" name="capassword" size="20" tabindex="7" /></td>
		  </tr>
		   <tr>
			<td>Email:</td>
			<td><input type="email" class="form-control" name="email" id="email" tabindex="4" placeholder="Enter your Email"></td>
			<td> </td>
			 
	   </tr>
	   <tr>
			<td></td>
			<td align="center"><input type="submit"  class="btn btn-info"  title="Click to Save" tabindex="8" value="Save & Next" 
			   class="btn_wide" name="btninsert" onclick="return pass_check();" /></td>
