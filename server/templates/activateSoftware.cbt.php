...
?>
<div class="span10">
<a rel="facebox" href="templates/licenceKey.php">
...
<a rel="facebox" href="templates/systemWindow.php">
...
echo $timestamp =$datestr->format('l jS F (Y-m-d)'); ?> </td>
</tr>
<tr>
<th>Day(s) Left</th> <td> <span class="badge"> <?php print bdLast;  
?></span>  </td>
</tr>
<tr>
<th>Status</th> <td class="badge text-success"> <?php  if(bdLast >= 0): echo "Active"; endif;   ?>
</tr>
</table>
</div>
</div>
