...
<a href="?pid=1&action=Add Exam&Loader=<?php if(empty($_GET['Loader'])): echo "GroupHelper/"; else: echo $_GET['Loader']; endif; ?>"> <img  src="images/view-refresh-3.ico" alt="Refresh" title="Refresh" /> </a> 
 ...
 <div class="col-lg-3 innerMain-left"> 
...
<div class="row">
		...
		<div class="blue-img-white">Exam Group:	 </div>
			</div>	
			</div>	
...
?>
<select class="form-control" id="exambankId" name="exambankId" onChange="nextfunction(this.value)" required>
...
<div class="row">
						...
						<div class="blue-img-white">Course File:</div>
			</div>	
			</div>	
	...
	<div class="black-img-white row"> 	
				 <div class="col-offset-lg-4 col-lg-8 pull-right">
<div id="f1">
			 		<select class="form-control"  id="subId" name="subId"  onChange="myFunction();" required>
...
<div class="row">
						<div for="CourseCat" class="control-label col-lg-12 ">
						<div class="blue-img-white">Exam Title:</div>
</div>	
</div>	
...
<select class="form-control" id="examTypeId" name="examTypeId">
						...
						?>	
							<option value="<?php echo $examType['examTypeId']; ?>" >
						<?php echo  $examType['typeName']; ?>
						</option>
							<?php 
						endforeach;
						?>
						...
						<option value="">Exam Type Empty</option>
					<?php	endif;  ?> 
					</select>
...
<div class="row">
 ...
 <div id="previewFaces" class="previewFaces">
  ...
  <div class="col-lg-3 innerMain-right">
...
<div class="row">
						<div for="CourseCat" class="control-label col-lg-12 ">
						<div class="blue-img-white">Enable Sorting:</div>
</div>	
</div>	
	<div class="black-img-white row ">		
						 <div class="col-offset-lg-4 col-lg-8 pull-right">
<div id="showsorting1">
 <label class="switch"> 
   ...
   <input type="checkbox" name="showsorting"  id="showsorting">
