...
define("INCLUDES_CLASS_PATH", "classes");
}
...
//plugin settings
$configuration['plugins_path'] = $_SERVER['DOCUMENT_ROOT'] . '/newbeedy/includes/plugins';  //absolute path to plugins folder, e.g c:/mycode/test/plugins or /home/phpobj/public_html/plugins
define('DIR_FS_BACKUP', 'includes/backups/');
define('PHP_DATE_TIME_FORMAT', 'm/d/Y H:i:s');
define('COMP_NAME', 'Schools');
define('CMP_OWNER', $_SESSION['cbt']['admin_user']);  
