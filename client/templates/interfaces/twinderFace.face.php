...
include_once('Flex-Exam_include.php');
?>
...
<button  type="submit" class="btn btn-warning pull-left col-lg-3 prevExamd" id="prevExamd" <?php if($process !=1): ?> onClick="prevClickfunction();" <?php endif; ?> >Previous</button>
...
<button  type="submit" class="btn btn-info pull-right nextExamd" id="nextExamd"  onClick="nextClickfunction();"> Next</button>
...
?>
<button class="btn btn-default" id="qnum<?php echo $x; ?>" onClick="nextfunction(<?php echo $x; ?>)">
<?php echo $x; ?></button> 
...
<br />
<hr class="pageGuide"/>  
<span> <button  id="stdProBtn" class="btn btn-warning">Profile </button> 
...
var  lastKey = parseInt(getStoredValue('lastKey'));
	...
	document.getElementById('prevExamd').disabled= true;    
...
$.ajax({
url:'templates/interfaces/Flexible_Exam_array.php?id='+number+'&index='+questionNumber+'&total='+total,
cache:false,
...
url:'templates/interfaces/Flexible_Exam_array.php?id='+number+'&random='+random+'&index='+questionNumber+'&total='+total,
...
document.getElementById('prevExamd').disabled= false; 
	}
...
document.getElementById('nextExamd').disabled= true; 
	...
	else if(queid >= <?php echo $Total_Question; ?>){
...
document.getElementById('nextExam').disabled= false; 
document.getElementById('nextExamd').disabled= false; 
	}
}
answered(queid);
...
//alert('f');
$.ajax({
url:'templates/interfaces/beedy_flex_mark.php?answers='+answers+'&questions='+questions+'&bankId='+bankId,
